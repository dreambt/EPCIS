...
@WebServiceClient(name = "EPCglobalEPCISService", wsdlLocation = "file:/d:/Workspaces/IdeaProjects/epcis-0.5.0/epcis-repository/src/main/resources/wsdl/EPCglobal-epcis-query-1_0.wsdl", targetNamespace = "urn:epcglobal:epcis:wsdl:1")
public class EPCglobalEPCISService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/epcis/query?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("无法从 http://localhost:8080/epcis/query?wsdl 初始化 WSDL.");
        }
        WSDL_LOCATION = url;
    }
