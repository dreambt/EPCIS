...
public class Query {
    ...
    /**
     * Whether this example should return ObjectEvents or not.
     */
    private boolean returnObjectEvents = false;

    /**
     * Whether this example should return AggregationEvents or not.
     */
    private boolean returnAggregationEvents = false;

    /**
     * Whether this example should return QuantityEvents or not.
     */
    private boolean returnQuantityEvents = false;

    /**
     * Whether this example should return TransacitonEvents or not.
     */
