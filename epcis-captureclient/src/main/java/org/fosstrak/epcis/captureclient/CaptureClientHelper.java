...
public class CaptureClientHelper {
     ...
     */
    public static final String toolTipDate = "格式: YYYY-MM-DDThh:mm:ss.SSSZ";
    public static final String toolTipUri = "URI";
    public static final String toolTipUris = "一个或者多个 URIs,以空格间隔";
    public static final String toolTipInteger = "整数";
    public static final String toolTipOptional = "可选";
    public static final String toolTipBizTransType = "业务事务类型";
    public static final String toolTipBizTransID = "业务事务 ID";
     ...
     *
     * @param cal The Calendar to be formatted.
    ...
    public static final class ExampleEvents {
        ...
        private static void initEvents() {
            ...
            ex.setDescription("DEMO 1: 给 Item 分配一个新的 EPC");
            ex.setType(0);
            ex.setEventTime("2011-09-20T06:36:17Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(0);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 2: 对 Item 进行质量检查");
            ex.setType(0);
            ex.setEventTime("2011-09-20T07:33:31.116Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(1);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 3: 将 Item 聚集为一个托盘");
            ex.setType(1);
            ex.setEventTime("2011-09-20T08:55:04Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(0);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 4: 托盘抵达某个港口");
            ex.setType(0);
            ex.setEventTime("2011-09-20T10:33:31.116Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(1);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 5: 托盘离开某个港口");
            ex.setType(0);
            ex.setEventTime("2011-09-21T13:27:08.155Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(1);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 6: Item 在生产过程中被读取");
            ex.setType(0);
            ex.setEventTime("2011-04-03T20:33:31.116Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(1);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 7: 2个托盘装上卡车");
            ex.setType(0);
            ex.setEventTime("2011-05-09T21:01:44Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(1);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 8: Item 送来维修");
            ex.setType(0);
            ex.setEventTime("2011-05-10T04:50:35Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(1);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO 9: 3个 Item 聚集到一个带有 EPC 的托盘");
            ex.setType(1);
            ex.setEventTime("2011-06-01T15:55:04Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(0);
            ex.setBizStep("urn:epcglobal:cbv:bizstep:packing");
            ex.setDisposition("urn:epcglobal:cbv:disp:in_progress");
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO10: 在消费端取消聚集");
            ex.setType(1);
            ex.setEventTime("2011-06-05T09:26:06Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(2);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO11: 库存盘点: 67 items");
            ex.setType(2);
            ex.setEventTime("2011-01-15T16:15:31Z");
            ex.setEventTimeZoneOffset("+08:00");
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO12: 客户修改订单 - 向本次交易新增2个 Item");
            ex.setType(3);
            ex.setEventTime("2011-08-18T11:53:01Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(0);
            ...
            ex = new CaptureEvent();
            ex.setDescription("DEMO13: 交易结束");
            ex.setType(3);
            ex.setEventTime("2011-08-20T07:03:51Z");
            ex.setEventTimeZoneOffset("+08:00");
            ex.setAction(2);
            ex.setBizTransaction("urn:epcglobal:cbv:fmcg:btt:po", "http://transaction.example.com/po/6677150");
            ex.setEpcList("urn:epc:id:sgtin:0057000.678930.5003 urn:epc:id:sgtin:0057000.678930.5004");
     ...
     *
     * @param filename The name of the file holding the image icon.
     ...
     * document.
     *
     * @param document The Document to generate the {@code <quantity>} element from.
     * @param root     The root Element under which the {@code <quantity>} element
     *                 should be generated.
     * @param quantity The value for the {@code <quantity>} element.
     ...
     * document.
     *
     * @param document The Document to generate the {@code <epcClass>} element from.
     * @param root     The root Element under which the {@code <epcClass>} element
     *                 should be generated.
     * @param epcClass The value for the {@code <epcClass>} element.
     ...
     *
     * @param document  The Document to generate the {@code <epc>} and {@code
     *                  <childEPCs>} element from.
     * @param root      The root Element under which the {@code <childEPCs>} element
     *                  should be generated.
     * @param childEPCs A space-separated list of EPCs.
     ...
     *
     * @param document        The Document to generate the {@code <bizTransactionList>}
     *                        element from.
     * @param root            The root Element under which the {@code <bizTransactionList>}
     *                        element should be generated.
     * @param bizTransactions A mapping of business transaction IDs to business transaction
     *                        types.
     ...
     *
     * @param document    The Document to generate the {@code <id>} and {@code
     *                    <bizLocation>} elements from.
     * @param root        The root Element under which the {@code <bizLocation>} element
     *                    should be generated.
     * @param bizLocation The value for the {@code <id>} element.
     ...
     * @param root      The root Element under which the {@code <readPoint>} element
     *                  should be generated.
     * @param readPoint The value for the {@code <id>} element.
     ...
     * XML document.
     *
     * @param document    The Document to generate the {@code <disposition>} element
     *                    from.
     * @param root        The root Element under which the {@code <disposition>} element
     *                    should be generated.
     * @param disposition The value for the {@code <disposition>} element.
     ...
     * document.
     *
     * @param document The Document to generate the {@code <bizStep>} element from.
     * @param root     The root Element under which the {@code <bizStep>} element
     *                 should be generated.
     * @param bizStep  The value for the {@code <bizStep>} element.
     ...
     * document.
     *
     * @param document The Document to generate the {@code <action>} element from.
     * @param root     The root Element under which the {@code <action>} element
     *                 should be generated.
     * @param action   The value for the {@code <action>} element.
     ...
     * @param root     The root Element under which the {@code <childEPCs>} element
     *                 should be generated.
     * @param epcList  A space-separated list of EPCs.
     ...
     * document.
     *
     * @param document The Document to generate the {@code <parentID>} element from.
     * @param root     The root Element under which the {@code <parentID>} element
     *                 should be generated.
     * @param parentID The value for the {@code <parentID>} element.
     ...
     * document.
     *
     * @param document  The Document to generate the {@code <eventTime>} element from.
     * @param root      The root Element under which the {@code <eventTime>} element
     *                  should be generated.
     * @param eventTime The value for the {@code <eventTime>} element.
     ...
     *
     * @param document            The Document to generate the {@code <eventTimeZoneOffset>}
     *                            element from.
     * @param root                The root Element under which the {@code <eventTimeZoneOffset>}
     *                            element should be generated.
     * @param eventTimeZoneOffset The value for the {@code <eventTimeZoneOffset>} element.
