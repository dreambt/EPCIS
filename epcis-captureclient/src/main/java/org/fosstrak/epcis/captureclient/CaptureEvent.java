...
public class CaptureEvent {
     ...
     */
    private String eventTimeZoneOffset = "+08:00";
    ...
    /**
     * @param type Sets the event type.<br>
     *             0 = ObjectEvent<br>
     *             1 = AggregationEvent<br>
     *             2 = QuantityEvent<br>
     *             3 = TransactionEvent
    ...
    /**
     * @param time Sets the event time. Use ISO8601, i.e. 2006-05-23T17:45:25
     */
    ...
    /**
     * @param timeZoneOffset Sets the event time zone offset.
     */
    ...
    /**
     * @param action Sets the action value.<br>
     *               0 = ADD<br>
     *               1 = OBSERVE<br>
     *               2 = DELETE
     */
    ...
    /**
     * @param step Sets the business step.
     */
    ...
    /**
     * @param disp Sets the disposition.
     */
    ...
    /**
     * @param readp Sets the read point.
     */
    ...
    /**
     * @param location Sets the business location.
     */
     ...
     *
     * @param t  The type of the business transaction.
     * @param id The id of the business transaction.
     */
    ...
    /**
     * @param list Sets the list of EPCs (for object and transaction events).
     */
    ...
    /**
     * @param epcs Sets the list of children EPCs (for aggregation events).
     */
    ...
    /**
     * @param id Sets the id of the parent object (for aggregation events).
     */
    ...
    /**
     * @param cls Sets the EPC class (for quantity events).
     */
    ...
    /**
     * @param n Sets the quantity (for quantity events).
     */
    ...
    public class BizTransaction {
         ...
         *
         * @param aType with the value of the BizTransTypeID.
         * @param aId   with the value of the BizTransID.
         */
